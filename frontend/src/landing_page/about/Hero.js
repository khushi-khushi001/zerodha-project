    ...
    return ( 
        <div className='container'>
            <div className='row p-5'>
                <h1 className='fs-6 text-center opc'>We pioneered the discount broking model in India.
                  <br></br> Now, we are breaking ground with our technology.
                </h1>
            </div>

            <div className='row mt-5 p-5 border-top '>
                <div className='col-6 font-lg text-muted ps-5'>
                ...
                <div className='col-6     font-lg text-muted pl-5'>
